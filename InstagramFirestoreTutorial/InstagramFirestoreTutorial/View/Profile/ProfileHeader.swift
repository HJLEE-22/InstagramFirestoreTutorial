...
class ProfileHeader: UICollectionReusableView {
    ...
    private lazy var follwingLabel: UILabel = {
       let label = UILabel()
        label.numberOfLines = 0
        label.textAlignment = .center
        return label
    ...
    override init(frame: CGRect) {
        ...
        let stack = UIStackView(arrangedSubviews: [postsLabel, followersLabel, follwingLabel])
    ...
    func configure() {
        ...
        follwingLabel.attributedText = viewModel.numberOfFollowing
